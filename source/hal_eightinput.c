...
int halKey20(BUTTON_INFO* btn){
	...
	// 0 1 2 3 4 に 正規化
	int num_5;
	num_5 = btn->f_key_move - CENTER_NUM;
	switch (num_5) {
		case -2: num_5 = 0; break;
		case -1: num_5 = 1; break; 
		case  0: num_5 = 2; break; 
		case +1: num_5 = 3; break; 
		case +2: num_5 = 4; break; 
	}

	// 0 ~ 11 に
	ret = (btn->f_key * 5) + num_5;
	return ret;
}
